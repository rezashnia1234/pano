...
console.log("ssss");
objMethods = getMethods( krpano );
// $("#placeholder").html(JSON.stringify(objMethods));
$("#placeholder").html(krpano.xml.view);
console.log(objMethods); // function :
/*
["registerattribute", "createobject", "removeattribute", "removeobject", "createarray", "removearray",
"getattributes", "set", "get", "call", "trace", "showtext", "screentosphere", 
"spheretoscreen", "loadFile", "decodeLicense", "haveLicense", "parsePath", "parsepath", "addplugin", "addlayer", "removeplugin", "removelayer", "addhotspot", "removehotspot"]

{"0","_type","registerattribute","createobject","removeattribute","removeobject","createarray","removearray","getattributes","set","get","call","trace","true","false","strict","version","build","buildversion","debugmode","tweentypes","basedir","showtext","bgcolor","logkey","showerrors","haveexternalinterface","havenetworkaccess","device","browser","_have_top_access","_isrealdesktop","iosversion","isphone","ispad","isandroid","ishtml5","isflash","ismobile","istablet","isdesktop","istouchdevice","isgesturedevice","stagewidth","stageheight","stagescale","area","wheeldelta","wheeldelta_raw","wheeldelta_touchscale","keycode","idletime","timertick","random","fullscreen","__swfpath","hlookat_moveforce","vlookat_moveforce","fov_moveforce","multireslevel","lockmultireslevel","downloadlockedlevel","mouse","view","screentosphere","spheretoscreen","loadFile","decodeLicense","haveLicense","parsePath","parsepath","contextmenu","control","cursors","plugin","layer","hotspot","events","display","memory","network","progress","xml","security","autorotate","math","action","scene","data","addplugin","addlayer","removeplugin","removelayer","addhotspot","removehotspot","webGL","onstart","vrheadsets","webvr_button_scale","style","webvr_setup_scale","xmlversion","start_ty","start_tt","vr_start_done","webVR","webvr","ask_user_for_screensize","i","image","preview"]

xml:
["url", "content", "scene", "view", "parsetime"]
*/
//windowMethods = getMethods( window );
// console.log(windowMethods); // function :
/*
["$", "jQuery", "init", "onDeviceReady", "createPanoViewer", "removepano", "embedpano", "embedpanoJS", "postMessage", "blur", "focus", "close", "onload", "stop", "open", "alert", "confirm", "prompt", "print", "requestAnimationFrame", "cancelAnimationFrame", "captureEvents", "releaseEvents", "getComputedStyle", "matchMedia", "moveTo", "moveBy", "resizeTo", "resizeBy", "getSelection", "find", "getMatchedCSSRules", "webkitRequestAnimationFrame", "webkitCancelAnimationFrame", "webkitCancelRequestAnimationFrame", "btoa", "atob", "setTimeout", "clearTimeout", "setInterval", "clearInterval", "requestIdleCallback", "cancelIdleCallback", "scroll", "scrollTo", "scrollBy", "fetch", "webkitRequestFileSystem", "webkitResolveLocalFileSystemURL", "openDatabase", "addEventListener", "removeEventListener", "dispatchEvent"]
*/
